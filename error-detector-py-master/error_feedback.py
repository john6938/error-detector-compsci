emoticons = {
    'Accuracy Detector': 'em-owl',
    'Brevity Detector': 'em-busts_in_silhouette',
    'Clarity Detector': 'em-radio_button',
    'Objectivity Detector': 'em-grinning_face_with_one_large_and_one_small_eye',
    'Formality Detector': 'em-beer'
}
...
error_dict = {
    'Accuracy Detector': {
        ...
        # TODO: Extract common factual errors from corpus and add regex
        'A2': {
        ...
        # TODO: Add regex to catch "all" used without modal or hedge
        'A3': {
        ...
        'A5': {
            ...
            'errors': [
                ...
                {
                    'regex': 'a\s+hour',
                    'help': "The first sound in \'hour\' is a vowel sound and so us the article \'an\' not \'a\'.",
                    'video': '',
                },
                # TODO: replace with POS regex
                ...
                {
                    'regex': 'averagely',
                    'help': "Replace \'averagely\' wtih \'on average\'."
                },
                {
                    'regex': 'that, if',
                ...
                {
                    'regex': 'a [aeiou]\w+',
                    'help': "Singular nouns that begin with a vowel sound are preceded by a, not an. Check this instance is correct."
                },
                {
                    'regex': 'works',
                ...
                {
                    'regex': 'much +\w*s',
                    'help': "Check that there is an uncountable noun. If there is a plural noun, replacing with \'many\'.",
                    'video': ''
                },
                # TODO: replace with POS regex
                ...
                {
                    'regex': 'Also',
                    'help': "We avoid using \'Also\' at the beginning of a sentence. If the main verb of this sentence is  \'be\'. place \'also\' immediately after it, e.g. \'This is also a problem\'. If the main verb of this sentence is  not \'be\', place \'also\' immediately before it, e.g. \'This can also help\'."
                },
                {
                    'regex': 'every +\w*s',
    ...
    'Brevity Detector': {
        ...
        # TODO: add regex to find content words repeated three times within one sentence
        # TODO: add video for repetition of same word - https://youtu.be/KteJJuko0ts
        'B3': {
            'title': 'Redundancy',
            'video': '',
            'errors': [
        ...
        'C1': {
            ...
            'errors': [
                ...
                {'regex': '(very long time)',
                 'help': "Rather than referring to a vague period of time, be specific if possible.", 'video': '', },
            ],
        },
        'C2': {
            ...
            'errors': [
                ...
                # {'regex': '(do|did|done)', 'help': "", 'video': '',},  # TODO rewrite to limit to main verb and not followed by article (a|an),

            ],
        },
        # right - https://youtu.be/lMCd3MhcpLA  TODO: write a help and text
        'C3': {
    ...
    'Objectivity Detector': {
        ...
        'O2': {
            ...
            'video': 'Sa1SF5URWCw',
            'errors': [
                {'regex': '(clearly|obviously)', 'help': "This adverb is subjective, and so it is likely others do not share  the same view. Consider rephrasing.", 'video': '', },
                {
                ...
                {'regex': '(at last|eventually)', 'help': "To increase the perception of objectivity avoid emotive terms.", 'video': '', },
            ],
        },
        # happy / pleased - https://youtu.be/Sa1SF5URWCw TODO add help text
        'O3': {
    ...
    'Formality Detector': {
        'F1': {
            ...
            'errors': [
                {
                    'regex': '(it\'s)',
                    'help': "Apostrophes to indicate the omission of a letter or letters are rather informal. Use the full form.\'.",
                    'video': 'vjaPFKo7Igo',
                },
                {
                    'regex': '(that\'s)',
        ...
        # apostrophe s - https://youtu.be/i-Q395Kouts - TODO
        # Japanese apostrophe - TODO
        # long dash - https://youtu.be/RAVttcjoKes  (TODO: add regex to find long dash)
        'F2': {'title': 'Abbreviation issues',
               'video': 'QdH6UKLzpkw'
               },
        # TODO: add regex to find first usage of abbreviations - three capitals or more used without brackets
        'F3': {
            'title': 'Slang',
            'video': 'ouUbbT3vjMQ',
            'errors': [
                ...
                {'regex': '(found out)',
                 ...
                 'video': '', },
                {'regex': '(ASAP)', 'help': "Use the full form.", 'video': '', },
                {'regex': '(find out)',
        ...
        'F4': {
            ...
            'errors': [
                {'regex': '(have not been +\w* yet)',
                 'help': "This is slightly informal. Replace with \'have not yet been ...\'.", 'video': '', },
                {'regex': '(`\w+)', 'help': "Replace the Japanese apostrophe with a  Western one \'.", 'video': '', },
                {'regex': '(lots of)',
                 'help': "\'lots of\' in rather informal. Use either \'much\' before uncountable nouns or \'many\' before plural nouns.  In some cases,to avoid repetition of \'much\' or \'many\', \'lots of\' may be acceptable.",
                 'video': '', },
                {'regex': '(a lot of)',
                 ...
                 'video': '', },
                {'regex': '(right) after', 'help': "\'right\' is quite informal. Replace with \'immediately\'.",
                 'video': '', },
                {'regex': '(right) before', 'help': "\'right\' is quite informal. Replace with \'immediately\'.",
                 'video': '', },
                {'regex': '(straight) after', 'help': "\'straight\' is quite informal. Replace with \'immediately\'.",
                 'video': '', },
                {'regex': '(straight) before', 'help': "\'straight\' is quite informal. Replace with \'immediately\'.",
                 'video': '', },
                {
                    'regex': '(And)',
                ...
                {'regex': '(has not been +\w* yet)',
                 'help': "This is slightly informal. Replace with \'has not yet been ...\'.", 'video': '', },
                {'regex': '(little bit)',
                ...
                {'regex': '(That is why)',
                 ...
                 'video': '', },
                {'regex': '(often)', 'help': "\'often\' is quite informal. Consider replacing with \'frequently\'.",
                 'video': '', },
                {'regex': '(sometimes)',
                 'help': "\'sometimes\' is quite informal. Consider replacing with \'occasionally\'.", 'video': '', },
            ],
        },
        'F5': {'title': 'Rhetorical questions',
               'video': 'JwFXB0JV8Qc'
               },
        # TODO: add regex to find question mark ?
        'F6': {
            'title': 'Phrasal verbs',
            'video': 'Y7NyWYXc8Ug',
            'errors': [
                {'regex': '(happen)', 'help': "\'happen\'is slightly informal. Replace with \'occur\'.", 'video': '', },
            ],
        },
    },
}
